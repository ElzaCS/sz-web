...
const Home = () => {
  ...
  return (
    <div 
    // style={{backgroundImage: "linear-gradient(to bottom right, #000000, #132774)"}}
    >
      {/* <Cta split /> */}
      ...
      <img className="bg-opacity" src="https://media.istockphoto.com/photos/abstract-gradient-dark-purple-background-gradient-dark-purple-color-picture-id1162940275?k=20&m=1162940275&s=612x612&w=0&h=ivJZi4m8aKpzROUB4QauxpKjT4frurVmB_Iy9T_tWIM=" style={{width: '1000px'}} />
